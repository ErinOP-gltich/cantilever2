        ...
        <div className="container mx-auto px-4 max-w-md">
          <Card className="card-elevated animate-fade-in">
            <CardHeader className="text-center">
              <CardTitle className="text-2xl font-bold">Join Cantilever</CardTitle>
              <CardDescription>
                Create your creator account and start earning from your designs
              </CardDescription>
            </CardHeader>
            ...
            <CardContent className="space-y-6">
              <form onSubmit={handleSubmit} className="space-y-4">
                  ...
                  <div className="relative">
                    ...
                    <Select onValueChange={handleProfessionChange}>
                      ...
                      <SelectContent>
                        ...
                        <SelectItem value="bim-specialist">BIM Specialist</SelectItem>
                ...
                <Button type="submit" className="w-full btn-hero" disabled={!formData.agreeToTerms}>
                  Create Account
                </Button>
              </form>
